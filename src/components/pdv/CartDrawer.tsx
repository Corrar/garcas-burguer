        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 space-y-6">
              ...
              return (
                <div key={item.id} className="bg-secondary rounded-xl p-4 shadow-sm">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-bold text-lg text-foreground">R$ {itemTotal.toFixed(2)}</span>
                  </div>
                </div>
              );
            })}
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full bg-card border border-border rounded-xl p-3 text-sm resize-none h-20 focus:outline-none focus:ring-2 focus:ring-primary shadow-sm"
            />
          </div>
